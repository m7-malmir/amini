...
class EditProduct extends ShowProduct {
    ...
    // به‌روزرسانی محصول
    public function updateProductContr($prtitle, $prcontent,$prsrc1, $prkey1 ,$prsrc2, $prkey2,$prsrc3, $prkey3 , $prsrc4, $prkey4, $feature) {
        // بررسی ورودی‌ها
        ...
        $this->updateProduct($this->postid, $prtitle, $prcontent, $uploadedPaths[0], $prkey1, $uploadedPaths[1], $prkey2, $uploadedPaths[2], $prkey3, $uploadedPaths[3], $prkey4, $feature);
